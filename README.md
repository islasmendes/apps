...
- **Acuracidade do Relato:** painel abaixo da matriz comparando, por indicador, o **relato (check-out) × o sistema**, com **Acuracidade %** e **Aderência check-in**.
...
- **Sistema (Auditoria):** lançamento dos números reais do sistema **por vendedor (em cards)** + taxas manuais (ex.: NPS).
